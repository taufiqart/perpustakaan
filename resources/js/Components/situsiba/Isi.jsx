...
export default function SituSiba({ papers, className = "" }) {
    return (
        <div className={`w-full ${className}`}>
            <div className="backdrop-blur-sm bg-white bg-opacity-60 w-full rounded-lg shadow-md">
                ...
                <div className="flex flex-col items-center pt-10">
                    ...
                    <div className="text-center text-base w-full px-5 md:w-2/3 pt-5">
                        <p>
                            ...
                            Tulis seperti Cerpen, Novel ataupun karya ilmiah
                            agar dapat dipublish dan dibaca oleh umum.
                        </p>
                    </div>
                </div>
                {/* Judul SITU SIBA end */}
