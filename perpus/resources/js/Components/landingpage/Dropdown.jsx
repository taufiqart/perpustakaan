                    ...
                    {data &&
                        data.child.map((dat) => {
                            return (
                                <Link
                                    href={dat.slug}
                                    class="relative bg-white w-full md:w-48 inline-flex items-center justify-center px-4 py-1 font-medium duration-200 md:rounded-tr-sm hover:shadow-xl group hover:ring-1 hover:bg-green-400"
                                >
                                    <svg
