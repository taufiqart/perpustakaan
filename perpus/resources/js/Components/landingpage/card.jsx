        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm ">
                ...
                <div className="p-5">
                    ...
                    <a href="#" className="text-white bg-gradient-to-r from-green-400 to-blue-400 hover:bg-green-400 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center">
                        Selengkapnya
